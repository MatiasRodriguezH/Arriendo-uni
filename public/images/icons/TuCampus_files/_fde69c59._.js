...
const AuthProvider = (t0)=>{
    ...
    if ($[0] !== "5f7ddf9eb82a3ec00abd32a0f00fe4550f8cfc7240c0de4248a74d740efc49c4") {
        for(let $i = 0; $i < 11; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5f7ddf9eb82a3ec00abd32a0f00fe4550f8cfc7240c0de4248a74d740efc49c4";
    }
    const { children } = t0;
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = async ()=>{
            ...
            if (token) {
                ...
                if (response.ok) {
                    const user_0 = await response.json();
                    if (user_0[0]) {
                        setUser(user_0[0]);
                        setIsLogin(true);
                    } else {
...
_s(AuthProvider, "FJiP8dvrhiegAEMkUVDw5+UbEWE=");
_c = AuthProvider;
var _c;
...
//# sourceMappingURL=_fde69c59._.js.map